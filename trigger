...
DECLARE CONTINUE HANDLER FOR NOT FOUND SET hihaerror=true;
  ...
  etiq: LOOP
	...
	INSERT INTO missatge(data,assumpte,descripcio, estatMissatge, username, IdContingut) VALUES (getdate(),"Nueva película en el catálogo", "Hola! Estamos aumentando nuestro catálogo cadad dia. Preprara las palomitas y disfruta de la nueva película: ", false, locusername, IdContingut);
