    ...
    <body>
        ...
        <?php
            ...
            while($fila = mysqli_fetch_assoc($cerca)){
                ...
                //taula de bootstrap que imprimirà la factura, la data inici, la data fi i 
                //l'import de les factures que estan pendents de pagament
                //inclou un botó per a poder pagar les factures
