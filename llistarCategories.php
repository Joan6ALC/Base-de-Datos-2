        ...
        $query = "SELECT * from categoria ORDER BY nomCat ASC";
                                    ...
                                    while($row = mysqli_fetch_array($result)){
                                        ...
                                        if(isset($fav)){ // Imprimim el botó per eliminar favorit
                                            echo            '<a href="eliminarCategoriaFavorit.php?id='.$row['nomCat'].'&redir="llistaCategories.php"" class="btn btn-dark btn-sm"  title="Eliminar de favoritos"><i class="bi-star-fill" style="font-size: 0.9rem;"></i></a></center>';
