                        ...
                        <div class="shadow-lg p-4 mb-5 bg-body rounded">
                            <form action="editarContracteForm.php" method="post">
                                <div class="d-grid gap-2">
                                    ...
                                    <input name="nameus" class="form-control" value=<?php echo "'".$user."'" ?> readonly>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" name="dataalta" class="form-control" value =<?php echo "'".$datalt."'" ?> readonly>
                                        </div> 
                                        <div class="col-md-6">
                                            <label>Fecha de baja:</label>
                                            <input type="date" name="databaixa" class="form-control" value =<?php echo "'".$databaix."'" ?> readonly>
                                        </div> 
                                    </div>
                                    <label>Id de su contrato:</label>
                                    <input name="id" class="form-control" value=<?php echo "'".$idcontract."'" ?> readonly>
                                    <div class="row">
                                        <div class="col-md-6">
